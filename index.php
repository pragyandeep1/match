  ...
  <div class="game-container">
    ...
    <div class="card">
      <div class="card-back card-face">
        ...
        <img class="spider" src="Assets/Images/Spider.png" alt="card">
      </div>
      <div class="card-front card-face">
        ...
        <img class="card-value" src="Assets/Images/Bat.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Bones.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Cauldron.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Eye.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Skull.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Pumpkin.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Ghost.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
    ...
    <div class="card">
      ...
      <div class="card-front card-face">
        ...
        <img class="cob-web cob-web-bottom-left" src="Assets/Images/CobwebGrey.png">
        <img class="cob-web cob-web-bottom-right" src="Assets/Images/CobwebGrey.png">
        <img class="card-value" src="Assets/Images/Dracula.png" alt="card">
      </div>
    </div>
    <div class="card">
      <div class="card-back card-face">
